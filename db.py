...
class Database:
	...
	def _create_tables(self):
		...
		Creates the tables currency, vals and stats unless they already exist.
		"""
	...
	def _val_entry(self, name, slug, price_usd, price_btc, volume_usd, market_cap_usd,  
		  		   available_supply, datetime):
		...
		if (self._c.fetchone() is None):
			self._c.execute("INSERT INTO currency (name, slug) VALUES (?, ?)",
				(name, slug,))
			self._conn.commit()
		# Insert values
